...
\begin{tikzpicture}
\begin{axis}[
    title={Opening Weekend MAE dependence on n-grams},
    xlabel={ngrams used},
    ylabel={Opening weekend MAE (\$M)},
    xmin=1, xmax=5,
    ymin=7, ymax=12,
    xtick={1,2,3,4,5},
    xticklabels={1-1,1-2,1-3,2-2,3-3},
...
\addplot[
    ...
    coordinates {
    (1,9.124)(2,8.444)(3,9.044)(4,9.238)(5,10.023)
    };
    \legend{reviews}
...
\addplot[
    ...
    coordinates {
    (1,10.567)(2,10.345)(3,10.316)(4,11.550)(5,11.460)
    };
...
\addplot[
    ...
    coordinates {
    (1,8.724)(2,8.310)(3,9.020)(4,9.527)(5,10.960)
    };
...
\addplot[
    ...
    coordinates {
    (1,26.767)(2,27.290)(3,27.238)(4,27.500)(5,30.732)
    };
    \legend{reviews}
...
\addplot[
    ...
    coordinates {
    (1,32.923)(2,32.553)(3,32.424)(4,33.462)(5,34.530)
    };
    \addlegendentry{subtitles}
...
\addplot[
    ...
    coordinates {
    (1,27.249)(2,27.179)(3,27.326)(4,28.467)(5,30.216)
    };
    \addlegendentry{reviews+subtitles}
